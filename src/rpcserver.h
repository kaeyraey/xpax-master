...
extern json_spirit::Value getdifficulty(const json_spirit::Array& params, bool fHelp); // in rpcblockchain.cpp
extern json_spirit::Value netmhashps(const json_spirit::Array& params, bool fHelp); // in rpcblockchain.cpp
