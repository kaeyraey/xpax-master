...
public:
    ...
    {
        // xpax: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // xpax: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // xpax: two types of block: proof-of-work or proof-of-stake
    ...
    // xpax: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // xpax: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
    int64_t nMoneySupply;
#endif
    unsigned int nFlags;  // xpax: block index flags
    enum
    {
