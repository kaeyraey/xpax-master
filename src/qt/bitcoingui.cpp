...
{
    resize(900, 520);
    setWindowTitle(tr("Xpax") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/xpax-48"));
    setWindowIcon(QIcon(":icons/xpax-48"));
#else
    ...
    // Title bar styling
    setObjectName("xpax");
    setStyleSheet("#xpax { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #cecece, stop: 1 #e4e4e4);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Xpax address"));
    ...
    aboutAction = new QAction(tr("&About Xpax"), this);
    aboutAction->setToolTip(tr("Show information about Xpax"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Xpax"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/xpax-48"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/xpax_testnet"));
            setWindowIcon(QIcon(":icons/xpax_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/xpax_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Xpax client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Xpax client"));
    trayIcon->setIcon(QIcon(":/icons/xpax-48"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xpax network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(tr(clientModel->isImporting() ? "Importing blocks..." : "Synchronizing with XPAX network..."));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Xpax address or malformed URI parameters."));
    }
