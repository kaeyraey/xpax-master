...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XPAX");
    case mBTC: return QString("mXPAX");
    case uBTC: return QString::fromUtf8("μXPAX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Xpaxs");
    case mBTC: return QString("Milli-Xpaxs (1 / 1,000)");
    case uBTC: return QString("Micro-Xpaxs (1 / 1,000,000)");
    default: return QString("???");
    }
}
