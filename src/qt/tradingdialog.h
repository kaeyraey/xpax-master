...
private slots:
    ...
    QString BuyXPAX(QString OrderType, double Quantity, double Rate);
    QString SellXPAX(QString OrderType, double Quantity, double Rate);
